...
public class FFGLMoveRightBottomProNode extends FFGLNode {
    class TextureInfo {
        int mTextureId;
        int mTextureWidth;
        int mTextureHeight;
...
//            "    gl_FragColor = mixColor;\n" +
    ...
    public FFGLMoveRightBottomProNode(Context context) {
        mContext = context;
    }
...
//        fs = mFragmentShaderStringMoveDown;
        ...
        mShaderProgramID = FFGLShaderUtils.initShader(mVertexShaderString, fs9);
