...
public class FFGLZoomOutProNode extends FFGLNode {
    class TextureInfo {
        int mTextureId;
        int mTextureWidth;
        int mTextureHeight;
    ...
    public FFGLZoomOutProNode(Context context) {
        mContext = context;
    }
...
//        updateTexture(rId7, mTexture7ID);
    ...
    private void initShader() {
        ...
        mShaderProgramID = FFGLShaderUtils.initShader(mVertexShaderString, fs1);
