...
public class FFGLMoveUpNode extends FFGLNode {
    class TextureInfo {
        int mTextureId;
        int mTextureWidth;
        int mTextureHeight;
    ...
    public FFGLMoveUpNode(Context context) {
        mContext = context;
    }
...
//        String fs = mFragmentShaderStringFadeInOut;
        String fs = mFragmentShaderStringMoveUp;
//        String fs = mFragmentShaderStringMoveDown;
