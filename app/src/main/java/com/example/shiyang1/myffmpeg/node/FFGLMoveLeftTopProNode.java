...
public class FFGLMoveLeftTopProNode extends FFGLNode {
    class TextureInfo {
        int mTextureId;
        int mTextureWidth;
        int mTextureHeight;
    ...
    public FFGLMoveLeftTopProNode(Context context) {
        mContext = context;
    }
...
//        updateTexture(rId7, mTexture7ID);
    ...
    private void initShader() {
        ...
        mShaderProgramID = FFGLShaderUtils.initShader(mVertexShaderString, fs6);
